...
Then(
  ...
  async function (args1) {
    await this.browser.page.importPage().assert.domPropertyEquals(
      {
...
When(/^user clicks on "([^"]*)" of Germplasm table$/, async function (args1) {
  await this.browser.page.importPage().click({
...
Then(/^user can see "([^"]*)" preview table$/, async function (args1) {
  await this.browser.page.importPage().assert.visible("#import-experiment div.b-table");
});

Then(/^user can not see "([^"]*)" preview table$/, async function (args1) {
  await this.browser.page.importPage().assert.not.elementPresent("#import-experiment div.b-table");
});
...
Then(
  ...
  async function () {
    await this.browser.page.importPage().assert.not.elementPresent(
...
Then(/^user can see "([^"]*)" in preview table$/, async function (args1) {
  ...
  await this.browser.page.importPage().assert.visible(
    {
...
Then(
  ...
  async function (args1) {
    switch (args1) {
      case "Genotypic Data":
        await this.browser.page.importPage().assert.visible("@genotypicDataTab");
        break;
      default:
...
When(
  ...
  async function (s) {
    await this.browser.page.importPage().setValue("@projectNameField", s);
  }
);
