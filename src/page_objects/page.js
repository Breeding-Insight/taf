  ...
  commands: [
    {
      ...
      navigateToProgram: async function (program) {
        ...
        await this.click("@showAllButton").saveScreenshot(`./screenshots/showallbutton.png`);
        await this.attach(fs.readFileSync(`./screenshots/usercheck.png`), 'showallbutton/png');;
        await this.click({
