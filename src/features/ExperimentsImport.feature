...
Feature: Experiments & Observations
    ...
    @BI-1701
    @debug
    Scenario Outline: Preview Experiment and observation import
        #Create a new program
        When user selects 'New Program' button in Programs page
        When user sets "<ProgramName>" in Program Name field in Programs page
        When user selects "<Species>" in Species dropdown in Programs page
        ...
        When user pause for "10" seconds
        Then user can see "Import Experiments & Observations" preview table
        Then user can see "Review your experimental data import before committing to the database." message on preview table
        Then user can not see "User" column in preview table
        Then user can not see "Date" column in preview table
        Then user can not see "Experiment Metadata" column in preview table
