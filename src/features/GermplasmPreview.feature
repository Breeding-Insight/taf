...
Feature: Germplasm Preview Tests
	...
	Scenario Outline: Add a “Synonyms” column to the germplasm import template
		...
		Then user can see Synonyms "Germ" on "1" of Preview Table
		Then user can see Synonyms "Germ1" on "2" of Preview Table
		Then user can see Synonyms "Germ2" on "3" of Preview Table
		Then user can see Synonyms "Germ3" on "4" of Preview Table
		Then user can see Synonyms "Germ" on "5" of Preview Table
		Then user can see Synonyms "Germ" on "6" of Preview Table
		Then user can see Synonyms "Germ" on "7" of Preview Table
		Then user can see Synonyms "Germ" on "8" of Preview Table
		Then user can see Synonyms "Germ" on "9" of Preview Table
		Then user can see Synonyms "" on "10" of Preview Table
